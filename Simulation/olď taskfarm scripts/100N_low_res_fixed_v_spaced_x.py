...
width_N_vals = np.linspace(10., 110., num=vertical_pixels, endpoint=True)  # width / number_of_cars dimensionless
print(width_N_vals)
dec_acc_vals = np.linspace(0, 200., num=horizontal_pixels, endpoint=True)   # dec / acc dimensionless
print(dec_acc_vals)
