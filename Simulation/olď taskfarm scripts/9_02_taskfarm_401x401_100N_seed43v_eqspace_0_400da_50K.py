...
# Changing variables
vertical_pixels = 401
horizontal_pixels = 401
width_N_vals = np.linspace(10., 210., num=vertical_pixels, endpoint=True)  # width / number_of_cars dimensionless
print(width_N_vals)
dec_acc_vals = np.linspace(0, 400., num=horizontal_pixels, endpoint=True)   # dec / acc dimensionless
print(dec_acc_vals)
...
np.savez("databank/09-02-401x401_100N_seed42v_eqspace_0to400da_50K",
