...
width_N_vals = np.linspace(10., 35., num=vertical_pixels, endpoint=False)  # width / number_of_cars dimensionless
dec_acc_vals = np.linspace(0., 50., num=horizontal_pixels, endpoint=False)   # dec / acc dimensionless
